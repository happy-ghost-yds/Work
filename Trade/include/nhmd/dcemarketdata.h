#ifndef _DCEMRKETDATA_H_
#define _DCEMRKETDATA_H_
...
#pragma pack(1)     /* set alignment to 1 byte boundary */
    struct ftdc_struct_mdl
    {
        char ftdc_struct_md_id[31];
        char ftdc_struct_md_time[9];
        unsigned int ftdc_struct_md_ms : 32;

        double ftdc_struct_md_last_price;
        unsigned int ftdc_struct_md_volume : 32;
        double ftdc_struct_md_last_turnover;
        double ftdc_struct_md_last_openinteres;

        double ftdc_struct_md_bid1;
        unsigned int ftdc_struct_md_bid_vol1 : 32;
        double ftdc_struct_md_ask1;
        unsigned int ftdc_struct_md_ask_vol1 : 32;

    };
    struct ftdc_struct_mdl2 {
        // position 0
        char ftdc_struct_md_head_id[31];
        char ftdc_struct_md_head_time[9];
        unsigned int ftdc_struct_md_head_ms : 32;
        // position 44
        double ftdc_struct_md_extra_openprice;
        double ftdc_struct_md_extra_highestprice;
        double ftdc_struct_md_extra_lowestprice;
        double ftdc_struct_md_extra_closeprice;
        double ftdc_struct_md_extra_upperlimitprice;
        double ftdc_struct_md_extra_lowerlimitprice;
        double ftdc_struct_md_extra_setprice;
        double ftdc_struct_md_extra_currdelta;
        ...
        unsigned int ftdc_struct_md_ask_vol1 : 32;
        // position 160
        double ftdc_struct_md_bid2;
        unsigned int ftdc_struct_md_bid_vol2 : 32;
        double ftdc_struct_md_bid3;
        unsigned int ftdc_struct_md_bid_vol3 : 32;

        // position 184
        double ftdc_struct_md_ask2;
        unsigned int ftdc_struct_md_ask_vol2 : 32;
        double ftdc_struct_md_ask3;
        unsigned int ftdc_struct_md_ask_vol3 : 32;
        // position 208
        double ftdc_struct_md_bid4;
        unsigned int ftdc_struct_md_bid_vol4 : 32;
        double ftdc_struct_md_bid5;
        unsigned int ftdc_struct_md_bid_vol5 : 32;

        // position 232
        double ftdc_struct_md_ask4;
        unsigned int ftdc_struct_md_ask_vol4 : 32;
        double ftdc_struct_md_ask5;
        unsigned int ftdc_struct_md_ask_vol5 : 32;
    };
#pragma pack()
